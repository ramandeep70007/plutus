        ...
        <div class="page-body">
          ...
          <div class="container">
            <div class="row">
             ...
             <div class="col-lg-6">
             <label for="clientSelect">Select Employee:</label>
...
// });
        ...
        $('#clientSelect').on('change', function () {
            var selectedClientName = $(this).val();

            // Filter table by client name
            table.column(1).search(selectedClientName, true, false).draw();
        });
        ...
        $('#employeeSelect').on('change', function () {
            ...
            table.column(0).search(selectedEmployeeName, true, false).draw();
        });
    });
</script>
